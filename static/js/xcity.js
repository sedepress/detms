$.fn.xcity = function(pName,cName,aName){
    ...
    this.showP  = function(provinceList) {
        ...
        for (var i in provinceList) {
            ...
            if(pName==provinceList[i].name){
                ...
                this.p.append("<option selected value='"+provinceList[i].part_id+"'>"+provinceList[i].name+"</option>")
            }else{
                this.p.append("<option value='"+provinceList[i].part_id+"'>"+provinceList[i].name+"</option>")
            }
        }
        if(!is_pName){
    ...
    this.showC = function (cityList) {
        ...
        for (var i in cityList) {
            if(cName==cityList[i].name){
                ...
                this.c.append("<option selected value='"+cityList[i].part_id+"'>"+cityList[i].name+"</option>")
            }else{
                this.c.append("<option value='"+cityList[i].part_id+"'>"+cityList[i].name+"</option>")
            }
        }
    ...
    this.showA = function (areaList) {
        ...
        for (var i in areaList) {
            ...
            if(aName==areaList[i]){
                this.a.append("<option selected value='"+i+"'>"+areaList[i]+"</option>")
            }else{
                this.a.append("<option value='"+i+"'>"+areaList[i]+"</option>")
            }
        }
    }
